...
func TestCycle_AddActivity(t *testing.T) {
	...
	tests := []struct {
		...
		{"valid", &Cycle{}, args{act: &Activity{Uuid: "", Date: "2024-01-01", Order: -1, Name: "", Description: "", Notes: "", Type: EmptyActivityType(), TypeSubtypeList: []*ActivityTypeSubtype{}, EquipmentList: []*ActivityEquipment{}, Planned: EmptyPlanned(), Completed: EmptyCompleted()}}, false},
		{"invalid", &Cycle{}, args{act: &Activity{Uuid: "", Date: "-01-01", Order: -1, Name: "", Description: "", Notes: "", Type: EmptyActivityType(), TypeSubtypeList: []*ActivityTypeSubtype{}, EquipmentList: []*ActivityEquipment{}, Planned: EmptyPlanned(), Completed: EmptyCompleted()}}, true},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestActivity_CompletionColor(t *testing.T) {
	...
	tests := []struct {
		...
		{"test", fields{Uuid: "", Date: "2024-01-01", Planned: &Planned{Distance: measurement.CreateMeasurement("m", 10), Duration: 10, Vertical: measurement.CreateMeasurement("m", 10)}, Completed: &Completed{Distance: measurement.CreateMeasurement("m", 10), Duration: 10, Vertical: measurement.CreateMeasurement("m", 10)}}, colorutil.Green, false},
		{"blue no planned", fields{Uuid: "", Date: "2024-01-01", Planned: &Planned{Distance: measurement.CreateMeasurement("m", 0), Duration: 0, Vertical: measurement.CreateMeasurement("m", 0)}, Completed: &Completed{Distance: measurement.CreateMeasurement("m", 10), Duration: 10, Vertical: measurement.CreateMeasurement("m", 10)}}, colorutil.Blue, false},
		{"test", fields{Uuid: "", Date: "2024-01-01", Planned: &Planned{Distance: measurement.CreateMeasurement("m", 10), Duration: 0, Vertical: measurement.CreateMeasurement("m", 10)}, Completed: &Completed{Distance: measurement.CreateMeasurement("m", 10), Duration: 10, Vertical: measurement.CreateMeasurement("m", 10)}}, colorutil.Green, false},
		{"red warning", fields{Uuid: "", Date: "2024-01-01", Planned: &Planned{Distance: measurement.CreateMeasurement("m", 10), Duration: 10, Vertical: measurement.CreateMeasurement("m", 10)}, Completed: &Completed{Distance: measurement.CreateMeasurement("m", 10), Duration: 15.1, Vertical: measurement.CreateMeasurement("m", 10)}}, colorutil.Red, false},
		{"yellow warning", fields{Uuid: "", Date: "2024-01-01", Planned: &Planned{Distance: measurement.CreateMeasurement("m", 10), Duration: 10, Vertical: measurement.CreateMeasurement("m", 10)}, Completed: &Completed{Distance: measurement.CreateMeasurement("m", 10), Duration: 15.0, Vertical: measurement.CreateMeasurement("m", 10)}}, colorutil.Yellow, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			a := &Activity{
